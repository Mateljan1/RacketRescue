...
export const metadata: Metadata = {
  ...
  description: 'Professional racquet stringing services from $25. Same-day service available. Expert customization and grip replacement.',
}
...
const services = [
  {
    ...
    turnaround: '2-3 Days',
    icon: Check,
    description: 'Professional stringing service for all skill levels.',
    features: [
      'Professional stringing to your exact specifications',
      'Tension range: 40-70 lbs',
      'String recommendations based on your playing style',
      'Quality guaranteed with pre-stretch techniques',
      'Racquet inspection included',
      'Starting knots professionally tied',
    ],
    ideal: 'Perfect for recreational players and regular practice',
  },
  {
    id: 'same-day',
    ...
    features: [
      'Drop off before noon, pick up the same day',
      'Priority queue - your racquet gets strung first',
      'Perfect for tournament preparation',
      'All standard service benefits included',
      'Text notification when ready',
      'Emergency service sometimes available',
    ],
    ideal: 'Ideal for tournament players and match preparation',
  },
  {
    id: 'customization',
