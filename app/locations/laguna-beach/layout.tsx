...
export const metadata: Metadata = {
  ...
  description: 'Professional tennis racquet stringing in Laguna Beach with FREE pickup & delivery. 4.9★ rated, USRSA certified. 24-hour turnaround. Serving all Laguna Beach neighborhoods.',
  ...
  openGraph: {
    ...
    description: 'Professional stringing with FREE pickup & delivery in Laguna Beach. 4.9★ rated. 24-hour turnaround.',
