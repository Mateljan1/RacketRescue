      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-racket-black via-racket-charcoal to-racket-black">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-8">
            ...
            <span className="font-semibold">Serving Laguna Beach</span>
          </div>

          <Image
            src={LOGO_URL}
            alt="Racket Rescue Laguna Beach"
            width={350}
            height={90}
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight max-w-5xl mx-auto mb-6">
            Tennis Racquet Stringing in Laguna Beach
          </h1>

          <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-8">
            Professional racquet stringing with FREE pickup & delivery in Laguna Beach.
            We come to your home, office, or tennis club.
          </p>
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 mb-8">
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
              ...
              <span className="text-white/80 text-sm">from Laguna Beach players</span>
            </div>
          </div>
        ...
        <div className="container-racket">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-racket-black text-center mb-12">
              We Cover All of Laguna Beach
            </h2>

            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-racket-lightgray rounded-2xl p-8">
                <h3 className="text-2xl font-bold text-racket-black mb-6">Areas We Serve</h3>
      ...
      <section className="py-20 bg-gradient-to-br from-racket-red to-red-600 text-white">
        <div className="container-racket text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Laguna Beach's trusted stringing service. 24-hour turnaround with free pickup for members.
          </p>
