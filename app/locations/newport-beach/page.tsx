      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-racket-black via-racket-charcoal to-racket-black">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-8">
            ...
            <span className="font-semibold">Serving Newport Beach</span>
          </div>

          <Image
            src={LOGO_URL}
            alt="Racket Rescue Newport Beach"
            width={350}
            height={90}
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight max-w-5xl mx-auto mb-6">
            Tennis Racquet Stringing in Newport Beach
          </h1>

          <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-8">
            Professional racquet stringing with FREE pickup & delivery in Newport Beach.
            From Balboa Island to Corona del Mar.
          </p>
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 mb-8">
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
              ...
              <span className="text-white/80 text-sm">from Newport Beach players</span>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-racket-red to-red-600 text-white">
        <div className="container-racket text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Newport Beach's trusted stringing service. 2-3 day turnaround with free pickup for members.
          </p>
